---
description: "Spec-driven QA gate — checks a diff against R3's foundation docs before you commit, via the r3-doc-qa agent."
---
...
3. Spawn the `r3-doc-qa` agent (Agent tool, `subagent_type: "r3-doc-qa"`), running in the foreground since its findings gate the commit. Tell it exactly which git command defines the diff scope so it runs the same one itself.
